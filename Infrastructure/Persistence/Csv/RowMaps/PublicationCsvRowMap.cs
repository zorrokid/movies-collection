...
using Infrastructure.Persistence.Csv.TypeConverters;

namespace Infrastructure.Persistence.Csv.RowMaps
{
    public class PublicationCsvRowMap : ClassMap<CsvRow>
    {
        public PublicationCsvRowMap()
        {
            Map(m => m.Id).Name("Id");
