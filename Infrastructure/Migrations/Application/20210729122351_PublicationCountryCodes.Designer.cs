...
namespace Infrastructure.Migrations.Application
{
    ...
    [Migration("20210729122351_PublicationCountryCodes")]
    partial class PublicationCountryCodes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.ProductionCompanyRole", b =>
                {
                    ...
                    b.ToTable("ProductionCompanyRoles");
                });
            ...
            modelBuilder.Entity("Domain.Entities.ProductionPersonRole", b =>
                {
                    ...
                    b.ToTable("ProductionPersonRoles");
                });
            ...
            modelBuilder.Entity("Domain.Entities.PublicationCountryCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("PublicationCountryCode");
                });
            ...
            modelBuilder.Entity("Domain.Entities.ProductionPersonRole", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Production", "Production")
                        .WithMany("ProductionPersonRoles")
                        .HasForeignKey("ProductionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.PublicationCountryCode", b =>
                {
                    b.HasOne("Domain.Entities.Publication", null)
                        .WithMany("PublicationCountryCodes")
                        .HasForeignKey("PublicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Domain.Entities.Production", b =>
                {
                    ...
                    b.Navigation("ProductionPersonRoles");
            ...
            modelBuilder.Entity("Domain.Entities.Publication", b =>
                {
                    ...
                    b.Navigation("PublicationCountryCodes");
